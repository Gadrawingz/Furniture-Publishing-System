  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav nav-link">
        ...
        <?php if(isset($_SESSION['stfName'])) { ?>
          <li><button class="btn btn-success btn-lg"><i class="fa fa-user text-white">&nbsp;</i><?php echo $_SESSION['stfName'];?></button></li>
        ...
        <?php } else { ?>
          ...
          <li>
            <a href="../home/signin.php" id="login" >
